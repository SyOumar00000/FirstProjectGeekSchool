<!-- <?php include('espace_membre/espace_membre/config.php') ?>
<?php
...
$dest_dossier = 'MES_IMAGES/'; //nom du dossier ou vous allez stocké vos images
$dest_fichier="";
...
if( file_exists($_FILES['avatar']['tmp_name']) and filesize($_FILES['avatar']['tmp_name']) > $taille_max)
{
