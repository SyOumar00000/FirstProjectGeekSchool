...
<head>
	...
	<title>.::Panneau de l'Administrateur ::.</title>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="change_admin_password.php?aUN=<?php echo $row['Administrator']; ?>"><i class="halflings-icon cog"></i> Changez Votre Mot De Passe
								</a></li>
								<li><a href="logout.php"><i class="halflings-icon off"></i> Deconnexion</a></li>
							</ul>
						</li>
						<!-- end: User Dropdown -->
					</ul>
